...
@Composable
fun MonitorPreview() {
  // Creating CPUStat data for a dual-core, 4-thread machine
  val cpuStats =
    mapOf(
  ...
  // Creating NetworkStat data for one network interface
  val networkStats =
    mapOf(
      "eth0" to NetworkStat(inetTxTotalBytes = 1500000, inetRxTotalBytes = 2500000),
    )

  // Creating three instances of NodeStat with varying data
  val nodeStat1 =
    NodeStat(
      displayOn = true,
      powerW = 50f,
